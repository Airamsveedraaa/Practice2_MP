...
public class Prueba {
	...
	public static void main(String[] args) {
        ...
        if (c2.equals(c1) && c3.equals(c4))
            Cliente.SetFechaDefecto(f3.diaSig());
        System.out.print("Fecha alta por defecto: " + Cliente.getFechaPorDefecto() + "\n");
        ...
        c[2]=cm; cm.SetNombre(c1.getNombre()); cm.SetFechaAlta(f1); cm.setPermanencia(f1);
        f1.setFecha(4,4,2004); aux=cm.getPermanencia(); aux.setFecha(20, 20, 2020);
